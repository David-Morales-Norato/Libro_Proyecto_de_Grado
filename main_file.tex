...
% ------------------------------------------------------------------------
\input{Secs/Portada}   % Portada, contraportada, formato de nota y autorización
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
\include{Secs/Resumen}                                               % Resumen
\include{Secs/Abstract}                                              % Abstract
% ------------------------------------------------------------------------
% Capítulos
% ------------------------------------------------------------------------
\input{Secs/Introducción} % Introducción
\input{Secs/Objetivos} % Objetivos
\input{Secs/Marco_de_referencia} % Marco de referencia
\input{Secs/Metodología} % Modelo matemático del DRON
\input{Secs/Resultados} % Controladores PI y su conjunto estabilizante
\input{Secs/Conclusiones} % Conclusiones
\input{Secs/Trabajo_Futuro} % Trabajo futuro
